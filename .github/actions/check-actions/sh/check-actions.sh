...
print_exemption_instructions() {
    echo "::error::If this action is not directly called by a workflow, you "
    echo "::error::can skip this check by adding <# check-workflow: exempt> "
    echo "::error::to the action.yaml file."
}
